    ...
    render(){
      ...
      {/* <h3>Page of {this.props.pgnum + 1}</h3> */}
                ...
                <h3>{this.props.cate}</h3>
                       ...
                       { this.props.getdata && this.props.getdata.map((e,index) => {
                            return (
            ...
            <Container>
                    ...
                    { this.props.getdata1 && this.props.getdata1.map((e,index) => {
                ...
                <Container>
                    ...
                    { this.props.getdata2 && this.props.getdata2.map((e,index) => {
